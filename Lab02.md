...
- Cuál es su mayor utilidad
    ...
    Facilitar el proceso de creación y gestión de cualquier proyecto.
- Fases de maven

    compile, test, package, validate
...
- Para qué sirven los plugins
    ...
    Un plugin es un componente que ejecuta una o varias tareas en el proceso de construcción. Por ejemplo, el plugin Compiler hace dos tareas (maven goals): compilar el código y la tarea o goal TestCompile
- Qué es y para qué sirve el repositorio central de maven

    Es un repositorio desde el cual maven puede descargar librerías que podemos luego utilizar en nuetro código. Similar a npm the Node.js
